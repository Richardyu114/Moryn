...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "Expanding `Audit Trail` shows the single `Audit Trail API index` with `Audit Reports`, `Store Snapshot`, and");
    expectText(dashboard, "`Raw Store` rows");
