...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "Need action? -> Needs attention? / All clear / Review suggested");
    expectText(dashboard, "Stored what? -> the `At a glance` memory-state chart and `What Moryn remembers`");
    ...
    expectText(dashboard, "The `At a glance` row is visible above `Technical details`");
