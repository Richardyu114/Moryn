...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "plain labels such as `Inspect saved content`, `Check details`, `Open related views`, and");
    expectText(dashboard, "`Sources and status`");
    ...
    expectText(dashboard, "Memory State uses restrained figures rather than KPI tiles");
    expectText(dashboard, "What Changed shows three to five prioritized events");
    expectText(dashboard, "reading drawer is read-only");
