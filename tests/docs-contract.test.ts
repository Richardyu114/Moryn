...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "The memory card also shows a compact `Long-term` / `Recently saved` / `For this session` mix bar");
    ...
    expectText(dashboard, "`Long-term` filters to memory Moryn can use now");
    expectText(dashboard, "`Recently saved` filters to saved-but-not-final items");
    ...
    expectText(dashboard, "If the state is only `Recently saved`, the visible saved-later panel");
    ...
    expectText(dashboard, "`For this session` is lookup context");
    ...
    expectText(dashboard, "when the only state is `Recently saved`, `For this session`, or");
    ...
    expectText(dashboard, "The search panel also shows a live result mix for `Long-term`,");
    expectText(dashboard, "`Recently saved`, `For this session`, `Kept for history`, and `Events`");
    ...
    expectText(dashboard, "shows available `Recently saved`, `Long-term`, `For this session`, and");
    ...
    expectText(dashboard, "long-term <- canonical records");
    expectText(dashboard, "recently saved <- candidate records");
    expectText(dashboard, "Each inventory state card is clickable");
    expectText(dashboard, "applies the matching read-only filter");
    expectText(dashboard, "for this session <- raw records");
    expectText(dashboard, "kept for history <- archived or quarantined records");
    expectText(dashboard, "`Recently saved` means the item is already saved and searchable");
