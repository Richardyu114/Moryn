...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "Stored what? -> What Moryn remembers");
    expectText(dashboard, "State now? -> This device, Recent status");
    expectText(dashboard, "Shared copy? -> Shared copy");
