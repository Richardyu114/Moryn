...
describe("documentation contracts", () => {
  ...
  it("documents the observability dashboard server and static artifact", async () => {
    ...
    expectText(dashboard, "timeline and recall trace commands under a `Trace commands` fold with kind/type and short record-id context instead of a generic `Details` row");
