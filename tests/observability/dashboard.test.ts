...
describe("observability dashboard", () => {
  ...
  it("renders a human-first dashboard with memory inventory, shared copy, recent status, and language switch", async () => {
    ...
    try {
      ...
      expect(data.memory_inventory.states.map((state) => state.label)).toEqual(["Ready to use", "Saved, not organized", "Session notes", "Kept for history"]);
      ...
      expect(detailHtml).toContain("<dd data-memory-explorer-detail-state data-i18n-en=\"Saved, not organized\" data-i18n-zh=\"已保存待整理\">Saved, not organized</dd>");
      ...
      expect(html).toContain("data-memory-explorer-state-zh=\"已保存待整理\"");
      ...
      expect(html).toContain("<strong data-i18n-en=\"Saved, not organized\" data-i18n-zh=\"已保存待整理\">Saved, not organized</strong>");
      ...
      expect(html).toContain("<span data-i18n-en=\"Ready to use\" data-i18n-zh=\"可直接使用\">Ready to use</span>");
      expect(html).toContain("<small data-i18n-en=\"Moryn can use this as long-term memory.\" data-i18n-zh=\"Moryn 可以把这些作为长期记忆使用。\">Moryn can use this as long-term memory.</small>");
      ...
      expect(html).toContain("<span data-i18n-en=\"Saved, not organized\" data-i18n-zh=\"已保存待整理\">Saved, not organized</span>");
      expect(html).toContain("<small data-i18n-en=\"Saved and searchable; not long-term memory yet.\" data-i18n-zh=\"已保存并可搜索；还不是长期记忆。\">Saved and searchable; not long-term memory yet.</small>");
      ...
      expect(html).toContain("<span data-i18n-en=\"Session notes\" data-i18n-zh=\"会话记录\">Session notes</span>");
      expect(html).toContain("<small data-i18n-en=\"Session context kept for lookup.\" data-i18n-zh=\"作为会话上下文保留，可供查找。\">Session context kept for lookup.</small>");
      ...
      expect(html).toContain("<span data-i18n-en=\"Kept for history\" data-i18n-zh=\"历史留存\">Kept for history</span>");
  ...
  it("supports command-style memory search shortcuts", async () => {
    await withTempStore(async (storePath) => {
      ...
      expect(html).toContain("<button type=\"button\" class=\"memory-search-chip\" data-memory-search-chip=\"state:remembered\" data-i18n-en=\"Ready to use\" data-i18n-zh=\"可直接使用\">Ready to use</button>");
      expect(html).toContain("<button type=\"button\" class=\"memory-search-chip\" data-memory-search-chip=\"state:to-organize\" data-i18n-en=\"Saved, not organized\" data-i18n-zh=\"已保存待整理\">Saved, not organized</button>");
