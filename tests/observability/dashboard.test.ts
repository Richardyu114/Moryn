...
describe("observability dashboard", () => {
  ...
  it("adds a read-only candidate triage queue for memory doctor backlog", async () => {
    await withTempStore(async (storePath) => {
      ...
      expect(html).toContain("<small>Context, review path, audit, samples</small>");
      ...
      expect(html.indexOf("data-dashboard-detail=\"candidate-triage-context:likely_noise\"", likelyNoiseGroupStart)).toBeGreaterThan(likelyNoiseDetailsStart);
      expect(html.indexOf("data-dashboard-detail=\"candidate-triage-review-path:likely_noise\"", likelyNoiseGroupStart)).toBeGreaterThan(likelyNoiseDetailsStart);
      expect(html.indexOf("data-dashboard-detail=\"candidate-triage-audit:likely_noise\"", likelyNoiseGroupStart)).toBeGreaterThan(likelyNoiseDetailsStart);
