...
describe("observability dashboard", () => {
  ...
  it("renders a human-first dashboard with memory inventory, shared copy, recent status, and language switch", async () => {
    ...
    try {
      ...
      expect(data.memory_inventory.states.map((state) => state.label)).toEqual(["Remembered", "To organize", "Session notes", "Set aside"]);
      ...
      expect(html).toContain("<span data-i18n-en=\"1 to organize\" data-i18n-zh=\"1 条待整理\">1 to organize</span>");
      ...
      expect(html).toContain("<small data-i18n-en=\"Long-term memory\" data-i18n-zh=\"长期记忆\">Long-term memory</small>");
      ...
      expect(detailHtml).toContain("<dd data-memory-explorer-detail-state data-i18n-en=\"To organize\" data-i18n-zh=\"待整理\">To organize</dd>");
      ...
      expect(html).toContain("data-memory-explorer-state-en=\"To organize\"");
      expect(html).toContain("data-memory-explorer-state-zh=\"待整理\"");
  ...
  it("renders a local memory search for stored records and events", async () => {
    await withTempStore(async (storePath) => {
      ...
      expect(html).toContain("data-memory-explorer-state-en=\"Remembered\"");
      expect(html).toContain("data-memory-explorer-state-zh=\"已记住\"");
      ...
      expect(html).toContain("data-memory-explorer-next-step=\"Already remembered\"");
      expect(html).toContain("data-memory-explorer-next-step-zh=\"已经记住\"");
      expect(html).toContain("data-memory-explorer-next-step-detail=\"This is already in long-term memory.\"");
      expect(html).toContain("data-memory-explorer-next-step-detail-zh=\"这条已经在长期记忆里。\"");
