...
describe("observability dashboard", () => {
  ...
  it("redacts quarantined record text and escapes rendered HTML", async () => {
    await withTempStore(async (storePath) => {
      ...
      expect(html).toContain("<span>Full diagnostic details</span>");
      expect(html).toContain("<small>3 reports</small>");
      ...
      expect(html).toContain("<span>Full audit details</span>");
      expect(html).toContain("<small>2 groups</small>");
