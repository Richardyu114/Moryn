...
describe("observability dashboard", () => {
  ...
  it("renders a human-first dashboard with memory inventory, shared copy, recent status, and language switch", async () => {
    ...
    try {
      ...
      expect(html).toContain("<span class=\"answer-memory-segment memory-state-new\" style=\"width: 33%\" title=\"Saved, not remembered 1\"></span>");
      ...
      expect(html).toContain("<span data-i18n-en=\"1 saved, not remembered\" data-i18n-zh=\"1 条已保存，未记住\">1 saved, not remembered</span>");
      ...
      expect(html).toContain("<article data-glance-summary=\"recent-writes\">");
      ...
      expect(html).toContain("<article data-glance-summary=\"remembered-now\">");
      ...
      expect(html).toContain("<article data-glance-summary=\"to-organize\">");
      ...
      expect(html).toContain("<article data-glance-summary=\"top-source\">");
