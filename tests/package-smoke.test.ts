  ...
  it("installs the packed CLI and runs memory operations from dist", async () => {
    await withTempDir(async (dir) => {
      ...
      try {
        ...
        expect(importCheck.stdout.trim()).toBe("artifacts.config|skills_by_id.<record_id>|pushed|guardrails_by_id.<guardrail_id>|error.next_action|error.next_action.arguments_by_name.<argument>|guardrails_by_id.<guardrail_id>|pushed|contracts.<group>.<contract>|artifacts.config|contracts.<group>.<contract>.<field>|operations_by_id.<operation>|operations_by_mcp_tool.<tool>|operations_by_cli_command.<command>|operations_by_id.<operation>.required_fields_by_name.<field>.allowed_values[]|operations_by_id.<operation>.execution.required_inputs_by_field.<field>|operations_by_id.<operation>.execution.required_inputs_by_argument_path.<argument_path>|operations_by_id.<operation>.execution.required_input_paths_by_value_path.<value_path>|operations_by_id.<operation>.arguments_by_name.<argument>|operations_by_id.<operation>.interfaces.cli.argv[]|operations_by_id.<operation>.interfaces.cli.executable|operations_by_id.<operation>.interfaces.cli.args[]|operations_by_id.<operation>.interfaces.cli.exec_file|operations_by_id.<operation>.interfaces.cli.placeholders[]|operations_by_id.<operation>.interfaces.cli.command_line|agent_enter|agent_enter|agent_enter|operations_by_id.<operation>|moryn|agent enter|moryn|agent enter|agent enter|moryn agent enter|moryn contracts operations|moryn|contracts operations|moryn|contracts operations|contracts operations|moryn contracts operations|moryn|write --kind <kind> --type <type> --scope <scope> --text <text>|moryn|write --kind <kind> --type <type> --scope <scope> --text <text>|write --kind <kind> --type <type> --scope <scope> --text <text>|moryn write --kind '<kind>' --type '<type>' --scope '<scope>' --text '<text>'|memory,skill,soul,session_summary,agent_note|run|collect_required_fields|user_input.summary|user_input.summary|operations_by_id.<operation>.execution.required_inputs_by_field.<field>|operations_by_id.<operation>.execution.required_inputs_by_argument_path.<argument_path>|execution.required_inputs_by_field.summary|operations_by_id.agent_finish|operations_by_id.agent_finish|agent_finish|operations_by_mcp_tool.agent_finish|operations_by_cli_command.moryn agent finish --summary <summary>|Provide summary.|summary|--summary");
