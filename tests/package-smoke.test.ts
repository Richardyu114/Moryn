    ...
    await withTempDir(async (dir) => {
      ...
      try {
        ...
        const parsedOperations = JSON.parse(operations.stdout) as {
          ...
          operations_by_id: {
            agent_enter: { interfaces: { cli: { command: string; argv: string[] } } };
            agent_finish: {
            ...
            operation_contracts: { interfaces: { cli: { argv: string[] }; mcp: { tool: string } } };
          };
        };
