    ...
    await withTempDir(async (dir) => {
      ...
      try {
        ...
        const importCheck = await exec("node", [
          "--input-type=module",
          "-e",
          "import { BOOT_SELECTION_SOURCES, GUIDE_SELECTION_SOURCES, NEXT_ACTION_SELECTION_SOURCES, OPERATION_CONTRACTS_SELECTION_SOURCES, SELECTION_SOURCE_CONTRACTS, SELECTION_SOURCE_CONTRACTS_SELECTION_SOURCES, getOperationContracts, getSelectionSourceContracts, STORE_INIT_SELECTION_SOURCES, SYNC_RESULT_SELECTION_SOURCES } from '@richardyu114/moryn'; const selectionResponse = getSelectionSourceContracts(); const operationResponse = getOperationContracts(); console.log(`${STORE_INIT_SELECTION_SOURCES.config_file}|${BOOT_SELECTION_SOURCES.skill}|${SYNC_RESULT_SELECTION_SOURCES.pushed}|${GUIDE_SELECTION_SOURCES.guardrail}|${NEXT_ACTION_SELECTION_SOURCES.error_next_action}|${NEXT_ACTION_SELECTION_SOURCES.error_argument}|${SELECTION_SOURCE_CONTRACTS.lifecycle.guide.guardrail}|${SELECTION_SOURCE_CONTRACTS.sync.result.pushed}|${SELECTION_SOURCE_CONTRACTS_SELECTION_SOURCES.contract}|${selectionResponse.contracts.setup.store_init.config_file}|${selectionResponse.selection_sources.field}|${OPERATION_CONTRACTS_SELECTION_SOURCES.operation}|${OPERATION_CONTRACTS_SELECTION_SOURCES.mcp_tool_operation}|${OPERATION_CONTRACTS_SELECTION_SOURCES.cli_command_operation}|${OPERATION_CONTRACTS_SELECTION_SOURCES.allowed_value}|${OPERATION_CONTRACTS_SELECTION_SOURCES.required_input}|${OPERATION_CONTRACTS_SELECTION_SOURCES.argument}|${OPERATION_CONTRACTS_SELECTION_SOURCES.cli_argv}|${OPERATION_CONTRACTS_SELECTION_SOURCES.cli_executable}|${OPERATION_CONTRACTS_SELECTION_SOURCES.cli_args}|${operationResponse.operations_by_id.agent_enter.interfaces.mcp.tool}|${operationResponse.operations_by_mcp_tool.agent_enter.operation}|${operationResponse.operations_by_cli_command['moryn agent enter'].operation}|${operationResponse.operations_by_id.agent_enter.selection_sources.operation}|${operationResponse.operations_by_id.agent_enter.interfaces.cli.executable}|${operationResponse.operations_by_id.agent_enter.interfaces.cli.args.join(' ')}|${operationResponse.operations_by_id.agent_enter.interfaces.cli.argv.join(' ')}|${operationResponse.operations_by_id.operation_contracts.interfaces.cli.command}|${operationResponse.operations_by_id.operation_contracts.interfaces.cli.executable}|${operationResponse.operations_by_id.operation_contracts.interfaces.cli.args.join(' ')}|${operationResponse.operations_by_id.operation_contracts.interfaces.cli.argv.join(' ')}|${operationResponse.operations_by_id.write.interfaces.cli.executable}|${operationResponse.operations_by_id.write.interfaces.cli.args.join(' ')}|${operationResponse.operations_by_id.write.interfaces.cli.argv.join(' ')}|${operationResponse.operations_by_id.write.arguments_by_name.kind.allowed_values.join(',')}|${operationResponse.operations_by_id.recall.execution.next_step}|${operationResponse.operations_by_id.agent_finish.execution.next_step}|${operationResponse.operations_by_id.agent_finish.execution.required_inputs[0].argument_source}|${operationResponse.operations_by_id.agent_finish.execution.required_inputs_by_field.summary.argument_source}|${operationResponse.operations_by_id.agent_finish.execution.required_inputs_by_field.summary.selection_sources.required_input}`);"
        ], { cwd: dir });
        ...
        const parsedOperations = JSON.parse(operations.stdout) as {
          ...
          operations_by_id: {
            agent_enter: { interfaces: { cli: { command: string; executable: string; argv: string[]; args: string[] } } };
            agent_finish: {
            ...
            write: { interfaces: { cli: { executable: string; argv: string[]; args: string[] } }; selection_sources?: Record<string, string>; execution: { required_inputs: Array<{ field: string; argument_paths: string[]; selection_sources?: Record<string, string>; mcp_targets?: Array<{ argument: string; type?: string; required?: boolean; preferred: boolean }>; cli_targets?: Array<{ flag?: string; positional?: string; type?: string; required?: boolean; repeatable?: boolean; default?: unknown; preferred: boolean }> }>; required_inputs_by_field: Record<string, { argument_paths: string[]; selection_sources?: Record<string, string>; mcp_targets?: Array<{ argument: string; type?: string; required?: boolean; preferred: boolean }>; cli_targets?: Array<{ flag?: string; positional?: string; type?: string; required?: boolean; repeatable?: boolean; default?: unknown; preferred: boolean }> }> }; required_fields_by_name: { kind: { allowed_values?: string[] } }; arguments_by_name: { kind: { allowed_values?: string[] } } };
            ...
            operation_contracts: { interfaces: { cli: { executable: string; argv: string[]; args: string[] }; mcp: { tool: string } } };
          };
        };
