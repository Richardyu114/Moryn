    ...
    await withTempDir(async (dir) => {
      ...
      try {
        ...
        const parsedOperations = JSON.parse(operations.stdout) as {
          ...
          operations_by_id: {
            agent_enter: { interfaces: { cli: { command: string; executable: string; argv: string[]; args: string[]; exec_file: { executable: string; args: string[] }; command_line: string } } };
            agent_finish: {
            ...
            operation_contracts: { interfaces: { cli: { executable: string; argv: string[]; args: string[]; exec_file: { executable: string; args: string[] }; command_line: string }; mcp: { tool: string } } };
          };
        };
