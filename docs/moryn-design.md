...
values, and numeric ranges follow the same pattern:
...
values, non-empty constraints, or bounds, and `retry_with` contains the
option/value placeholder to use for the corrected retry.
