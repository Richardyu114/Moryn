...
and mutation tools, and boolean mistakes on fields with core contracts usually
come back with `operation_contract`, `argument_sources`, and `retry_with`
instead of a host-only validation string.
