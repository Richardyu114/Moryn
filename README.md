...
including RFC3339 refresh cursor failures. MCP `recall.tags` and
`recall.record_ids` shape failures also pass through core validation, including
single-string tag and record id values. Project setup argument failures for
